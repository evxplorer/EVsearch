...
<table style={{ borderCollapse: 'collapse' }}>
  <tr>
    ...
    <td>{modelDetials.Model}</td>
  </tr>
  <tr>
    <td><strong>Ex Showroom Price:</strong></td>
    <td>{modelDetials['Ex Showroom Price']} Rs</td>
  </tr>
  <tr>
    <td><strong>Battery Size:</strong></td>
    <td>{modelDetials['Battery Size']}</td>
  </tr>
  <tr>
    <td><strong>Battery Type:</strong></td>
    <td>{modelDetials['Battery Type']}</td>
  </tr>
  <tr>
    <td><strong>Charger Rating:</strong></td>
    <td>{modelDetials['Charger Rating']}</td>
  </tr>
  <tr>
    <td><strong>Driving Range:</strong></td>
    <td>{modelDetials['Driving Range']} KM</td>
  </tr>
  <tr>
    <td><strong>Charging Time:</strong></td>
    <td>{modelDetials['Charging Time']} Hrs</td>
  </tr>
</table>
